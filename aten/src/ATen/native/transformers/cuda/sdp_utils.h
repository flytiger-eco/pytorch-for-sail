...
#ifdef USE_PPU // PPU modification: FA3 flex flash attention backend eligibility
C10_EXPORT bool can_use_flex_flash_attention(sdp_params const& params, bool debug);
#endif
